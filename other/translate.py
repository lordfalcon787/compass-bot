...
class Translate(commands.Cog):
    ...
    async def translate_cmd(self, ctx):
        try:
            ...
            english = await translator.translate(message_to_translate, dest="en")
            spanish = await translator.translate(message_to_translate, dest="es")
            chinese = await translator.translate(message_to_translate, dest="zh-cn")
